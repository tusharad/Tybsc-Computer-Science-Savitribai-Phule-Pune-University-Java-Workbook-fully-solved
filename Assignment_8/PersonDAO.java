...
public class PersonDAO {
	...
	/*
	 * Person Table needs to be created in the Oracle Database. create table Person
	 * ( id Integer, name Varchar(30), address Varchar(30), phone Integer, email
	 * Varchar(50) );
	 */
	...
	public PersonDAO() {
		...
		con = Ex8a1.getConnection(); // Create Connection to the Oracle Database
	}
	...
	public void savePerson(PersonInfo person) {
		try {
			String sql = "INSERT INTO Person (pname,address,phone,email) VALUES (?,?,?,?) ";
